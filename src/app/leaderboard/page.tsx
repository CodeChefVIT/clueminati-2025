...
export default function Leaderboard() {
  ...
  return (
    <div className="flex flex-col items-center h-full text-white">
      <h2 className="text-2xl text-center py-6 font-bold">Top Performers</h2>
        ...
        <div className="flex flex-col ">
          {teams.map((team) => (
            <div key={team.rank} className="relative w-full h-32 md:h-40">
              ...
              />
              <span className="absolute inset-0 flex items-center justify-start text-lg sm:text-3xl font-bold truncate px-8 z-10 left-15">
                {team.name.length > 20
